...
class Local {
  ...
  static readonly chartDailyAPI = '/chartDailyAPI'
  static readonly chartCmds = '/chartCommands'
  static readonly chartDailyCmds = '/chartDailyCommands'
  ...
  static readonly logDailyAPI = '/logDailyAPI'
  static readonly logCmds = '/logCommands'
  static readonly logDailyCmds = '/logDailyCommands'
